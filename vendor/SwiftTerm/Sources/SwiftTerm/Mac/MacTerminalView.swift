...
open class TerminalView: NSView, NSTextInputClient, NSUserInterfaceValidations, TerminalDelegate {
    ...
    /// Presentation-only foreground colors keyed by logical cell column.
    /// Row indices match Terminal.bufferLine(atRow:).
    public var rowForegroundProvider: ((Int, BufferLine, Int) -> [Int: Attribute.Color])? {
        didSet { terminal.updateFullScreen(); needsDisplay = true; queuePendingDisplay() }
    }
