...
struct SavedServerDrag: Codable {
    ...
    static func receive(_ providers: [NSItemProvider], workspace: Workspace, groupID: UUID?, completion: @escaping (Bool) -> Void = { _ in }) -> Bool {
...
private struct ServerGroupDropDelegate: DropDelegate {
    ...
    func performDrop(info: DropInfo) -> Bool {
        ...
        return SavedServerDrag.receive(info.itemProviders(for: [SavedServerDrag.typeIdentifier]), workspace: workspace, groupID: groupID)
    }
}
...
struct ServerGroupDropTarget: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content
            ...
            .onDrop(of: [SavedServerDrag.typeIdentifier], delegate: ServerGroupDropDelegate(workspace: workspace, groupID: groupID, feedback: feedback))
    }
}
