...
简体中文 · [English summaries](CHANGELOG.en.md)

保留仓库记录的各版本说明，按版本从新到旧排列。旧 Release 安装包清理后，本日志和各版本原始说明仍保留。历史说明中的安装路径、依赖及限制以对应版本为准。当前使用方法见 [README](README.md)，不要将历史版本的限制作为当前行为。英文入口提供各版本摘要，完整原始记录保留在本文件及各版本说明中。
